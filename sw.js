const CACHE='nes-y7-v1';
const CORE=['./','./index.html','./assets/css/site.css','./assets/js/app.js','./assets/js/diagrams.js','./data/lessons.js','./assets/images/nes-logo.png','./assets/images/favicon.svg'];
